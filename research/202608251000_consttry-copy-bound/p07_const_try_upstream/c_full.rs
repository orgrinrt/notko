...
#![feature(try_trait_v2, try_trait_v2_residual, const_try, const_try_residual, const_trait_impl, const_destruct)]
#![no_std]
#![crate_type = "lib"]
...
const impl<T: [const] Destruct> Residual<T> for Maybe<Infallible> {
